package rbxrec::record::charset;

# module repris de Koha 3.16 : C4::charset (https://github.com/Koha-Community/Koha/blob/3.16.x/C4/Charset.pm)
...
sub SetMarcUnicodeFlag {
    ...
    if ($marc_flavour eq 'MARC21' || $marc_flavour eq 'NORMARC') {
        ...
        #warn "encodage: ", substr( $marc_record->subfield(100, 'a'), $encodingposition, 3 );
    } else {
